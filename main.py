...
# Cắt ảnh theo 4 góc
original = my_lib.cut(original, upper_left, bottom_left, upper_right, bottom_right, depth_width, depth_height)
...
my_lib.plt_visualize(original, depth_width, depth_height, points) 
